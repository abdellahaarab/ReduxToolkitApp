...
function FormDelete() {
    ...
    const buttonStyle ="bg-gradient-to-r from-orange-300 via-amber-500 to-cyan-100 text-indigo-900 dark:bg-slate-900 rounded-xl p-2 ring-1 ring-slate-900/5 shadow-xl"
